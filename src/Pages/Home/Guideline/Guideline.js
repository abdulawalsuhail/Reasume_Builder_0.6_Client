...
const Guideline = () => {
    return (
        <section className='py-20 guidelineBackground'>
            <div className=' md:w-[70%] mx-auto shadow-lg pt-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3  pb-28'>
                    <div className='mb-12 md:mb-0'>
                        <img className='mx-auto w-[160px]' src={img_3} alt="" srcset="" />
                        <h1 className='text-center pt-4 pb-2 text-4xl text-accent'>Step 1</h1>
                        <p className='px-12 md:px-24 mx-auto text-md text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, cumque?</p>
                    </div>
                    <div className='mb-16 md:mb-0'>
                        <img className='mx-auto w-[120px]' src={img_4} alt="" srcset="" />
                        <h1 className='text-center pt-4 pb-2 text-4xl text-accent'>Step 2</h1>
                        <p className='px-12 md:px-24 mx-auto text-md text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, cumque?</p>
                    </div>
                    <div>
                        <img className='mx-auto w-[110px]' src={img_5} alt="" srcset="" />
