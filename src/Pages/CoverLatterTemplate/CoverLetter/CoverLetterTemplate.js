...
const CoverLetterTemplate = () => {
  ...
  return (
    <div className="bg-[#f4f7f8] min-h-screen py-20">
      <div className="w-[65%] mx-auto bg-white p-16 ">
        ...
        <div className="text-[15px] poppins-t text-gray-600">
          ...
          <p className="mb-3">
            ...
            Name]. This experience was incredibly valuable, as it helped me kick
            off my career in {jobRole} in three different fields:
          </p>
          ...
          <ul class="list-disc pl-4 pb-3">
            ...
            <li>
              I also contributed to the [Project/Responsibility] that allowed us
              to [Improvements].
            </li>
            <li>
              Furthermore, I assisted the department lead and provided material
              for [Project/Responsibility].
            </li>
          </ul>

          <p className="mb-4">
            The reason why I consider the above a defining experience for me is
            the results I was able to achieve. skill three helped me to
            [improvement] by [30%].
          </p>
          ...
          <p className="my-4">
            ...
            person who can address challenging tasks such as Biggest Chalange. I
            can fulfil this expectation, because {challenge}
          </p>
