                ...
                <div className="w-[100%] md:w-[70%] text-center">
                    ...
                    <div className='flex justify-center'>
                        <form id='certificateId' className='mt-12 w-[100%] md:w-[80%]'>
                            <input name='certificate_1' type="text" placeholder="License/Certification" class="input input-bordered w-full mb-4 h-14" /><br />
                            <input name='certificate_2' type="text" placeholder="License/Certification" class="input input-bordered w-full mb-4 h-14" /><br />
                            <input name='certificate_3' type="text" placeholder="License/Certification" class="input input-bordered w-full mb-4 h-14" />
                        </form>
                    </div>
