    ...
    return (
        <div className='mx-12 my-8'>
            <div className='flex'>
                {/* input section */}
                <div style={{width:"67%"}}>
                    <h1 className='text-accent text-4xl font-bold'>Do you have any licenses or certifications?</h1>
                    <p className='text-slate-500 text-lg mt-2'>Enter your licenses or certifications one at a time.</p>
