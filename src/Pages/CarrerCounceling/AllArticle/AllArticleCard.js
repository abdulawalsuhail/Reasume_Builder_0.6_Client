...
const AllArticleCard = ({ article }) => {
  const { title, blog, name, date,_id } = article;
    ...
    <div>
      <div class="card max-w-sm h-[200px] mt-6 mx-auto  bg-base-100 shadow-xl">
        <div class="card-body">
          ...
          <p className="text-[18px] text-gray-600">{blog.slice(0,50)}
          
          
          <span onClick={()=>navigate(`/career-counselling/blog/${_id}`)} className="text-[15px] font-bold text-[#3f66da]">see more...</span>
          </p>
