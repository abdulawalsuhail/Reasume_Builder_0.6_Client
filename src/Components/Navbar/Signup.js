  ...
  return (
    <section className="text-white bg-gray-900 relative">
      <img
        ...
        alt="resume"
      />
      <div class="hidden sm:block sm:inset-0 sm:absolute sm:bg-gradient-to-r sm:from-slate-800 sm:to-slate-500 opacity-75"></div>
      <div className="grid md:grid-cols-2 mx-auto  py-10 relative">
        {/* left side */}
